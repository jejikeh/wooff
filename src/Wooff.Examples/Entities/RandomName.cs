...
/*
internal class RandomName : Entity<Information, Speaker, Transform>
{
    ...
    private static string HashToString(int hash, int asciiShift = 97, int asciiWidth = 17)
    {
        ...
        return Enumerable.Range(0, digits).Aggregate(resultString, (current, _) => current + (char)(((int)(hash / (Math.Pow(10, random.Next(digits)))) % 10) + (random.Next(asciiWidth) + asciiShift)));
    }

    public override IInitable<Information> Init(params Information[] data)
    {
        throw new NotImplementedException();
    }

    public override IInitable<Speaker> Init(params Speaker[] data)
    {
        throw new NotImplementedException();
    }

    public override IInitable<Transform> Init(params Transform[] data)
    {
        throw new NotImplementedException();
    }
}*/