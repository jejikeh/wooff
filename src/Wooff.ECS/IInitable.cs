...
public interface IInitable<T, T1, T2, T3> : IInitable
{
    ...
    public static T4 Initialize<T4>(T data, T1 dataT1, T2 dataT2, T3 dataT3) where T4 : IInitable<T, T1, T2, T3>, new()
    {
        var item = new T4();
...
public interface IInitable<T, T1, T2, T3, T4> : IInitable
{
    ...
    public static T5 Initialize<T5>(T data, T1 dataT1, T2 dataT2, T3 dataT3, T4 dataT4) where T5 : IInitable<T, T1, T2, T3, T4>, new()
    {
        var item = new T5();
